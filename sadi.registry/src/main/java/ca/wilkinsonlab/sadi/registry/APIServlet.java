...
import org.sadiframework.client.RegistryImpl;
...
public class APIServlet extends HttpServlet
{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		System.out.println("## APIServlet-doGet -> PATH=" +path);
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		Map<String, String> params = request.getParameterMap();
		String path = request.getPathInfo();
		System.out.println("## APIServlet-doPost -> PATH=" +path);
		for (APILocation apiLocation: apiLocations) {
			if (path.startsWith(apiLocation.getPath())) {
				Object result = null;
	...
	private static class Services implements GettableLocation
	{
		...
		{ 
			System.out.println("## APIServlet-get -> PATH=" +path);
